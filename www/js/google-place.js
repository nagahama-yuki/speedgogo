            ...
            link: function(scope, element, attrs, ngModel) {
                    ...
                    '<div class="ion-google-place-container modal">',
                        '<div class="bar bar-header item-input-inset">',
                            '<label class="item-input-wrapper">',
                                ...
                                '<input class="google-place-search" type="search" ng-model="searchQuery" placeholder="' + (attrs.searchPlaceholder || '住所を入力') + '">',
                            '</label>',
                ...
                popupPromise.then(function(el){
                    ...
                    scope.selectLocation = function(location){
                        ...
                        $(".ion-google-place-container.modal").animate({
                            top: "100%"
                        },300);
                        $("#googlePlaceCover, .ion-google-place-container.modal").delay(300).fadeOut(0);
                        $ionicBackdrop.release();
                        placeMapMove(location.formatted_address);
                        //console.log(location.formatted_address.replace(/(\d+)/g, "").replace("日本, ", "").replace("-", "").replace("〒", "").replace(" ", ""));
